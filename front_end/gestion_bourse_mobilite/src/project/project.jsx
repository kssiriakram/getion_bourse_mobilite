...
const Project = () => {
  ...
  const allProject = null;// useSelector(content => content.Projectapp.all_Project);
  const doingProject = null;//useSelector(content => content.Projectapp.doing_Project);
  const doneProject = null;//useSelector(content => content.Projectapp.done_Project);
            ...
            <Card>
              <CardBody>
                <TabContent activeTab={activeTab}>
                  <TabPane tabId="1">
                    <Row>
                      { allProject && allProject.map((item, i) =>
                  ...
                  <TabPane tabId="2">
                    <Row>
                      {doingProject && doingProject.map((item, i) =>
                        <Col sm="4" className="mt-4" key={i}>
                          <div className="project-box">
                  ...
                  <TabPane tabId="3">
                    <Row>
                      {doingProject && doneProject.map((item, i) =>
                        <Col sm="4" className="mt-4" key={i}>
                          <div className="project-box">
